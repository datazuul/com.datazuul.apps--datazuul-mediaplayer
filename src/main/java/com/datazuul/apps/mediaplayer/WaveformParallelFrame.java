...
public class WaveformParallelFrame extends JFrame {
  ...
  /**
   * This panel gets a signal with updateWave and each time he can (not busy), he asks the executor to run N_TASK tasks
   * that calculate the absolute position of the polyline relative to part of the signal (that is pcmdata)
   *
   * @author Pierluigi
   */
  class WaveformPanel extends JPanel {
    ...
    /**
     * This makes the executor run some task each task calculate position for part of the signal
     */
    ...
    /**
     * This task calculates part of the polyline, relative to a portion of the signal (pcmdata.lenght/N_TASK)
     *
     * @author Pierluigi
     */
