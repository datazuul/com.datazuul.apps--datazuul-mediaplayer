...
public class FFTParallelFrame extends JFrame {
  ...
  /**
   * JPanel that contains the frequency spectrum every frequency is drawn on screen as a rectangle every times a new
   * pcmdata is received, N_TASK tasks process a portion of the signal (that is pcmdata)
   *
   * @author Pierluigi
   */
  class FreqDiagPanel extends JPanel {
    ...
    /**
     * Splitted computation for each part of the signal Each task calculate the frequencies using a different part of
     * the signal One task do the math for the rectangles positions and lengths
     *
     * @author Pierluigi
     */
